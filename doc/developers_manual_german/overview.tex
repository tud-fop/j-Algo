...
Folgende minimale Systemanforderungen werden für den reibungslosen Einsatz von \jalgo benötigt:
\begin{itemize}
	...
	\item Monitor mit einer Auflösung von mindestens 800x600 
\end{itemize}
...
Öffnen Sie diese Datei mit einem Doppelklick, und das Programm wird gestartet.
...
Öffnen Sie die Konsole und starten sie mittles \verb|sh j-algo.sh| das Programm.
