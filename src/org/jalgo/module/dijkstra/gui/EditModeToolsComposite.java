...
import org.jalgo.module.dijkstra.actions.FileAction;
	...
	public EditModeToolsComposite(Controller ctrl, Composite arg0, int arg1) {
		...
		b
				.addMouseTrackListener(new StatusbarTextMouseTrackAdapter(
						getController(),
						"Mit dem Werkzeug \u201EKnoten hinzuf\u00FCgen/verschieben\u201C k\u00F6nnen neue Knoten durch Klicken auf die Zeichenfl\u00E4che erzeugt sowie vorhandene Knoten durch Klicken und Ziehen verschoben werden."));
		...
		b
				.addMouseTrackListener(new StatusbarTextMouseTrackAdapter(
						getController(),
						"Mit dem Werkzeug \u201EKante hinzuf\u00FCgen/bewerten\u201C k\u00F6nnen neue Kanten zwischen Knoten gezogen sowie vorhandene Kantengewichte durch Klicken und Ziehen auf die Gewichtszahl ver\u00E4ndert werden."));
		...
		b.setLayoutData(g);
		b
				.addMouseTrackListener(new StatusbarTextMouseTrackAdapter(getController(),
						"Mit dem Werkzeug \u201EKnoten l\u00F6schen\u201C k\u00F6nnen Knoten durch Anklicken entfernt werden."));
		...
		b
				.addMouseTrackListener(new StatusbarTextMouseTrackAdapter(getController(),
						"Mit dem Werkzeug \u201EKante l\u00F6schen\u201C k\u00F6nnen Kanten durch Klicken auf die Gewichtszahl entfernt werden."));
