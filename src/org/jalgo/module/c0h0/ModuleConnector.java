...
public class ModuleConnector extends AbstractModuleConnector{
	...
	JMenuItem beamerModeSelector;


	@Override
	public void init() {
		container = new ModuleContainer();
		controller = new Controller(container, JAlgoGUIConnector.getInstance().getModuleToolbar(
				this), JAlgoGUIConnector.getInstance().getModuleMenu(this));
	...
	@Override
	public void run() {
		TerminalView.println("C0H0 Module is running");
	}
