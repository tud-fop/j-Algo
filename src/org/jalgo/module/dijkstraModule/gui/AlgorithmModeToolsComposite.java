...
public class AlgorithmModeToolsComposite extends ControllerComposite {
    ...
    protected class ComboBoxObserver extends AlgoModeButtonAniObserver
    {
        ...
        public void update(Observable arg0, Object arg1)
        {
        	try
			{
                ...
                int iMaxNode = (((Controller)arg0).getGraph().getNodeList() == null)? 0 :((Controller)arg0).getGraph().getNodeList().size();
	...
	protected class ButtonObserver extends AlgoModeButtonAniObserver
	{
        ...
        public void update(Observable arg0, Object arg1) 
        {
	        ...
	        {           
                bEnable = ((m_bNext == true)? ctrl.hasNextMacroStep(ctrl.getCurrentStep()): ctrl.hasPrevMacroStep(ctrl.getCurrentStep()));
	        }
	        else
	        {
	            bEnable = ((m_bNext == true)? ctrl.hasNextStep(ctrl.getCurrentStep()): ctrl.hasPrevStep(ctrl.getCurrentStep()));
	        }
