 ...
 */
public class AM1Simulator {
	public AM1Simulator(final JComponent contentPane, final JMenu menu, final JToolBar toolbar) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				new Simulator().init(contentPane, menu, toolbar);
			}
		});
	}
}
