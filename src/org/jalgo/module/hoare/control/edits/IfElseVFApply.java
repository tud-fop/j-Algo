...
import org.jalgo.module.hoare.model.IfElseVF;
import org.jalgo.module.hoare.model.VerificationFormula;

public class IfElseVFApply implements UndoableEdit {

	Node node;

	VerificationFormula vf;

	public IfElseVFApply(VerificationFormula vf, Node node) {
		this.node = node;
		this.vf = vf;
	}
	...
	public void apply() throws InvalidParameterException {
		...
		if (vf.getType().equals(IfElseVF.class)) {
