...
public class GenerateWordAction extends Action {
	...
	public GenerateWordAction(ModuleController mc) {
		...
		setText(Messages.getString("synDiaEBNF",
			"GenerateWordAction.generate_word_algorithm_1")); //$NON-NLS-1$
		setToolTipText(Messages.getString("synDiaEBNF",
			"GenerateWordAction.Start_generate_word_algorithm._2")); //$NON-NLS-1$
		setImageDescriptor(ImageDescriptor.createFromURL(
			getClass().getResource("/ebnf_pix/generateWord.gif")));
	}
