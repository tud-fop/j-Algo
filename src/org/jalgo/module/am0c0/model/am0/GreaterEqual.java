 ...
 * @author David Voigt
 */
public class GreaterEqual extends CompareStatement {
	...
	public MachineConfiguration apply(MachineConfiguration configuration)
		...
		if (configuration.getStack().getStackAsList().size() < 2) {
			throw new IllegalArgumentException(
					Messages.getString("am0c0", "GreaterEqual.0")); //$NON-NLS-1$
		}
	...
	public String getDescription() {
		return Messages.getString("am0c0", "GreaterEqual.1"); //$NON-NLS-1$
	}
