...
/**
 * This is the action to delete a terminal symbol
 * 
 * @author Tom Kazimiers, Johannes Mey
 * 
 */
public class DeleteTerminalAction implements IAction {

	// The terminal Symbol that has been deleted
	ETerminalSymbol terminal;
	 ...
	 *            the controller that owns the definition
	 * @param terminal
	 *            the terinal symbol to be deleted
	 */
	public DeleteTerminalAction(EbnfController controller,
			ETerminalSymbol terminal) {
