...
public class RedoAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3212902833318621499L;
	private EbnfController ebnfController;

	public RedoAction(EbnfController ebnfController) {
		super();
		this.ebnfController = ebnfController;
		putValue(NAME, Messages.getString("ebnf", "EbnfInput.Redo"));
