...
extends AbstractAction {
	 ...
	 */
	public UndoAllAction(GUIController gui) {
		super();
		this.gui = gui;
		putValue(NAME, Messages.getString("ebnf", "Trans.UndoAll")); 
		putValue(SHORT_DESCRIPTION, Messages.getString("ebnf", "Trans.UndoAll"));
