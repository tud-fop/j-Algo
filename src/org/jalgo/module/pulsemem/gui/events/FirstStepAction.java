 ...
 */
public class FirstStepAction extends AbstractAction {
     ...
     * @param controller
     */
    public FirstStepAction(GUIController gui, Controller controller) {
        this.gui = gui;
        this.controller = controller;
        putValue(NAME, Messages.getString(
                "pulsemem", "FirstStepAction.firstStepShort")); //$NON-NLS-1$
        putValue(SHORT_DESCRIPTION, Messages.getString(
                "pulsemem", "FirstStepAction.firstStepLong")); //$NON-NLS-1$
