...
extends AbstractAction {
	...
	public AbortAction(GUIController gui, Controller controller) {
		...
		putValue(NAME, Messages.getString("avl", "Abort_algorithm")); //$NON-NLS-1$ //$NON-NLS-2$
		putValue(SHORT_DESCRIPTION,Messages.getString("avl", "Abort_algorithm_tooltip")); //$NON-NLS-1$ //$NON-NLS-2$
		putValue(SMALL_ICON,
			new ImageIcon(Messages.getResourceURL("main", "Icon.Abort_algorithm"))); //$NON-NLS-1$ //$NON-NLS-2$
	}
