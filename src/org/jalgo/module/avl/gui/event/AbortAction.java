...
extends SwingSWTAction {
	...
	public AbortAction(GUIController gui, Controller controller) {
		...
		setText(Messages.getString("avl", "Abort_algorithm")); //$NON-NLS-1$ //$NON-NLS-2$
		setToolTipText(Messages.getString("avl", "Abort_algorithm_tooltip")); //$NON-NLS-1$ //$NON-NLS-2$
		setIconImage(Messages.getResourceURL("avl", "Abort")); //$NON-NLS-1$ //$NON-NLS-2$
	}
