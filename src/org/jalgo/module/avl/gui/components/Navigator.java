...
/**
 * The class <code>Navigator</code> is a special feature for scrollpanes.
 * It can be added as e.g. lower right corner of the scrollpane and it gets
 * a reference to the viewport of the scrollpane.
 * When clicking in the corner a popup opens with a scaled preview of the
 * viewport content. Dragging the mouse the user can navigate through the
 * scrollpane.
 * 
...
implements MouseListener, MouseMotionListener {
	...
	public Navigator(GUIController gui, PaintArea paintArea) {
		...
		navigator = new JInternalFrame("Navigator");
		...
		map = new JComponent() {
			public void paint(Graphics g) {
				...
				//localisation conflicts caused by the SWT <-> Swing "cooperation"
	...
	/**
	 * When left mouse button is pressed, the popup is created and shown.
	 * The mouse cursor is moved to the center of the visible rect.
	 */
	...
	/**
	 * Releasing mouse causes to hide the navigator popup and to move the
