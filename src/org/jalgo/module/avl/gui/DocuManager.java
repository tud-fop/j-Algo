...
//				}
	...
	private String getKey(String name) {
		if (name.equals("Suchen"))
			return "search";
		if (name.equals("Einf�gen") || name.equals("Suchbaum Erstellen"))
			return "insert";
		if (name.equals("AVL-Einf�gen") || name.equals("AVL-Baum Erstellen"))
			return "avlinsert";
		if (name.equals("L�schen"))
			return "remove";
		if (name.equals("AVL-L�schen"))
			return "avlremove";
