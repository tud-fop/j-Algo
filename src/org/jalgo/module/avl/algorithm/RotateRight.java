...
extends Command {
	...
	public void perform() {
		...
		if (u.getParent() != null) if (u.getKey() > u.getParent().getKey()) u
			.getParent().setRightChild(u);
	...
	public void undo() {
		...
		if (v.getParent() != null) if (v.getKey() > v.getParent().getKey()) v
			.getParent().setRightChild(v);
