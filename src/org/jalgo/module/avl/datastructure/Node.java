...
implements Visualizable, Constants {
	...
	/**
	 * Constructs a <code>Node</code> object with the given key. A call to this
	 * constructor is equal to <code>Node(key, null)</code>.
	 * 
	...
	/**
	 * Constructs a <code>Node</code> object with the given key and the given node
	 * as parent node.
	 * 
	 * @param key the key of the node
	...
	/**
	 * Retrieves the parent node of this node. If this is the root node of a tree,
	...
	/**
	 * Sets the height of the partial tree with this node as root node to the given
	 * integer.
	 * 
	...
	/**
	 * Retrieves the stored height of the partial tree with this node as root node.
	 * 
	 ...
	 * Currently this String representation consists only of the key value.
	 * 
	...
	/**
	 * Tests if this instance of <code>Node</code> is equal to the given parameter.
	 * If the given parameter is an instance of <code>Node</code>, the key of the
	 * node is compared with the key of the other node.
	 * 
	 * @param other the <code>Object</code> to be compared with
	 * 
	 * @return <code>true</code>, if the given parameter is a node with the same
