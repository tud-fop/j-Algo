...
implements IModuleInfo {
	...
	public String getDescription() {
		return "A module that demonstrates how the levenshtein distance between a "
				+ "source word and a target word can be calculated.";
	}
	...
	public URL getHelpSetURL(){
		return Messages.getResourceURL("levenshtein","HelpSet_Name");
	}
}